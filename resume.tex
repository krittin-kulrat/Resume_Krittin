...
% CONTACT INFORMATION
%====================
\author{Krittin Kulrattanaruks} 
\def\phone{(206)-349-8208}
\def\city{Seattle}
\def\email{krittkul@uw.edu}
% blog edited in _header.tex
\def\github{krittin-kulrat} % github username
\def\LinkedIn{krittin-kulrat} % linkedin.com/in/______
